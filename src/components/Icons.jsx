...
const Icon = ({ children, size = 24, strokeWidth = 2, className = '', ...props }) => (
  <svg 
...
export const Gem = (props) => (
  <Icon {...props}>
    ...
    <polygon points="11 3 13 3 16 9 8 9 11 3"></polygon>
  </Icon>
);
...
export const Handshake = (props) => (
  <Icon {...props}>
    ...
    <path d="m14 14 2.5 2.5a1 1 0 1 0 3-3l-3.88-3.88a3 3 0 0 0-4.24 0l-7.38 7.38a6 6 0 1 0 8.49 8.49l.06-.06"></path>
  </Icon>
);
